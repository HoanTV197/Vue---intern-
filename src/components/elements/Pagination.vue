<template>
  <div class="pagination" v-if="total_pages > 1">
    ...
    >
      <img
        src="@/assets/images/icons/pagination1st.svg"
        alt="pagination1st"
        class="icon"
      />
    </button>
    ...
    >
      <img
        src="@/assets/images/icons/pagination_pre.svg"
        alt="pagination_pre"
        class="icon"
      />
    </button>
    <div v-for="page in items" :key="page.label">
      <button v-if="page.disable" class="page-link btn">...</button>
      <button
        v-else
    ...
    >
      <img
        src="@/assets/images/icons/pagination_net.svg"
        alt="pagination_next"
        class="icon"
      />
    </button>
    ...
    >
      <img
        src="@/assets/images/icons/pagination_last.svg"
        alt="pagination_last"
        class="icon"
      />
    </button>
...
const items = computed(() => {
  ...
  let extraNext =
    valNext === total_pages.value - 2 ? total_pages.value - 1 : null;
